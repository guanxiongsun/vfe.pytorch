...
class STPNSwinTransformer(BaseModule):
    """ Spatio-temporal Prompting Network with Swin Transformer
        TODO: chage url https://arxiv.org/abs/xxxx
    Args:
    ...
    def __init__(self,
        ...
        super(STPNSwinTransformer, self).__init__(init_cfg=init_cfg)
    ...
    def train(self, mode=True):
        ...
        super(STPNSwinTransformer, self).train(mode)
        self._freeze_stages()
