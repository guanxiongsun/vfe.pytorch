...
from ...bbox_heads.convfc_bbox_head import HEADS, ConvFCBBoxHead

from mmdet.models import build_aggregator
...
class MambaBBoxHead(ConvFCBBoxHead):
    ...
    def __init__(self, aggregator, topk=300, *args, **kwargs):
        super(MambaBBoxHead, self).__init__(*args, **kwargs)
    ...
    def forward(self, x, ref_x):
        ...
        if self.num_shared_fcs > 0:
            ...
            for i, fc in enumerate(self.shared_fcs):
                ...
                # update memory bank with enhanced x
    ...
    def _first_frame_forward(self, x, ref_x):
        ...
        if self.num_shared_fcs > 0:
            ...
            for i, fc in enumerate(self.shared_fcs):
                ...
                # reset memory bank for the first frame
