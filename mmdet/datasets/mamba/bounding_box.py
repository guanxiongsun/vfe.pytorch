...
class BoxList:
    ...
    The bounding boxes are represented as a Nx4 Tensor. In order to uniquely
    determine the bounding boxes with respect to an image, we also store the
    corresponding image dimensions. They can contain extra information that is
    ...
    def crop(self, box):
        """Crops a rectangular region from this bounding box.
